...
| 2026-08-13 | 직원 교육 — 레벨을 올리는 유일한 길(돈 + 그 사람의 2주 점유), 레벨 +1과 세 스탯 +5가 한 자리에서 오른다 | src/data/employees.ts, src/systems/employee.ts(+test), src/store.ts(+test), src/programs/Messenger.tsx·messenger.css |
